...
export const SETTING_DEFS: SettingDef[] = [
  ...
  { key: 'EGAP_TOKEN', env: 'EGAP_BOT_TOKEN', group: 'پیامک و ربات‌های پیام‌رسان', label: 'توکن ربات ای‌گپ', type: 'secret', default: '' },
  { key: 'EGAP_CHANNEL', env: 'EGAP_CHANNEL_ID', group: 'پیامک و ربات‌های پیام‌رسان', label: 'شناسهٔ کانال ای‌گپ', type: 'text', default: '' },
  ...
  { key: 'EGAP_BOT_ENABLED', env: 'EGAP_BOT_ENABLED', group: 'پیامک و ربات‌های پیام‌رسان', label: 'فعال‌سازی بات تعاملی ای‌گپ', type: 'boolean', default: 'false' },
  ...
  { key: 'EGAP_API_BASE', env: 'EGAP_API_BASE', group: 'پیامک و ربات‌های پیام‌رسان', label: 'نشانی API ای‌گپ', type: 'url', default: 'https://egap.ai/api' },
