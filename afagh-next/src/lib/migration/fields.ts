...
export const FIELD_SPECS: Record<string, FieldSpec[]> = {
  ...
  major: [
    ...
    { key: 'کد استادی مدیر گروه', title: 'مدیر گروه (کد استادی)', aliases: ['کد استادی مدیر گروه', 'کد مدیر گروه', 'head_staff_code'] },
    { key: 'نام مدیر گروه', title: 'نام مدیر گروه', aliases: ['نام مدیر گروه', 'مدیر گروه', 'head_name'] },
    { key: 'کارشناس رشته', title: 'کارشناس رشته', aliases: ['کارشناس رشته', 'کارشناس', 'expert_name'] },
    { key: 'آخرین جلسه شورای گسترش', title: 'آخرین جلسهٔ شورای گسترش', aliases: ['آخرین جلسه شورای گسترش', 'شورای گسترش', 'last_council_date'], hint: 'در فایل شما: «آخرين تاريخ جلسه شوراي گسترش جهت تمديد رشته»' },
  ],
  professor: [
    { key: 'کد استادی', title: 'کد استادی (ستون «کد»)', aliases: ['کد استادی', 'کد استاد', 'کد پرسنلی', 'staff_code', 'professor_code', 'code', 'کد'], required: true, hint: 'کلید یکتای استاد؛ بازاجرای فایل ردیف تکراری نمی‌سازد' },
    ...
    { key: 'نام و نام خانوادگی', title: 'نام کامل (نام + فامیل)', aliases: ['نام و نام خانوادگی', 'نام کامل', 'استاد', 'نام استاد', 'full_name'], hint: 'خودکار به نام/فامیل و لقب تفکیک می‌شود' },
    { key: 'نام خانوادگی و نام', title: 'نام کامل برعکس (فامیل + نام)', aliases: ['نام خانوادگی و نام', 'فامیل و نام', 'lastname_firstname'], hint: 'ترتیب برعکس؛ آخرین کلمه نام کوچک در نظر گرفته می‌شود' },
    ...
    { key: 'رشته و گرایش', title: 'رشته و گرایش', aliases: ['رشته و گرایش', 'رشته تحصیلی', 'field_of_study'] },
    { key: 'رشته', title: 'رشته (ستون جدا)', aliases: ['رشته', 'رشته اصلی', 'field'] },
    { key: 'دانشگاه محل اخذ آخرین مدرک تحصیلی', title: 'دانشگاه محل اخذ آخرین مدرک', aliases: ['دانشگاه محل اخذ آخرین مدرک تحصیلی', 'دانشگاه محل اخذ مدرک', 'دانشگاه', 'last_degree_university'] },
    { key: 'کد کشور آخرین مدرک تحصیلی', title: 'کد کشور آخرین مدرک', aliases: ['کد کشور آخرین مدرک تحصیلی', 'کد کشور', 'degree_country_code'] },
    ...
    { key: 'کد وضعیت تاهل', title: 'کد وضعیت تأهل', aliases: ['کد وضعیت تاهل', 'کد تاهل', 'marital_status_code'] },
    { key: 'نام پدر', title: 'نام پدر', aliases: ['نام پدر', 'father_name'] },
    { key: 'شماره شناسنامه', title: 'شمارهٔ شناسنامه', aliases: ['شماره شناسنامه', 'شناسنامه', 'birth_cert_no'] },
    { key: 'تاریخ تولد', title: 'تاریخ تولد', aliases: ['تاریخ تولد', 'birth_date'] },
    { key: 'محل تولد', title: 'محل تولد', aliases: ['محل تولد', 'place_of_birth'] },
    { key: 'محل صدور', title: 'محل صدور', aliases: ['محل صدور', 'place_of_issue'] },
    ...
    { key: 'ایمیل', title: 'ایمیل (آدرس الکترونیکی)', aliases: ['ایمیل', 'آدرس الکترونیکی', 'پست الکترونیک', 'email'] },
