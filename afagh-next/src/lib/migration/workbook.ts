...
const TEMPLATES: Record<WorkbookKind, TemplateDef> = {
  student: {
    ...
    example: [[
      ...
      'کارشناسی پیوسته', 'مهندسی کامپیوتر', 'فعال',
      '1234567890', 'سری ۱۲۳۴۵۶', 'محمد', '1381/03/15', 'تهران', 'تهران', 'زن', 'تهران، خیابان آزادی',
    ]],
    help: [
      '«مقطع» برای تفکیک رشته‌های هم‌نام در مقاطع مختلف لازم است (مثلاً «مهندسی کامپیوتر» در کارشناسی و ارشد).',
  ...
  department: {
    ...
    headers: ['کد گروه', 'نام گروه', 'دانشکده'],
    example: [['0101', 'گروه مهندسی کامپیوتر', 'دانشکده فنی و مهندسی'], ['0102', 'گروه مهندسی برق', '01']],
    help: [
      'ستون «دانشکده» می‌تواند نام دانشکده باشد یا کد آن — هر دو تطبیق می‌خورد.',
  ...
  major: {
    ...
    headers: [
      'کد رشته', 'نام رشته', 'مقطع', 'گروه آموزشی', 'دانشکده', 'گرایش', 'کد گرایش',
      'حداقل واحد', 'کد استاندارد', 'تاریخ تاسیس', 'تاریخ خاتمه', 'فعال',
      'کد استادی مدیر گروه', 'کارشناس رشته', 'آخرین جلسه شورای گسترش',
    ],
    example: [
      ['40113', 'مهندسی کامپیوتر', 'کارشناسی پیوسته', 'گروه مهندسی کامپیوتر', 'دانشکده فنی و مهندسی', 'نرم‌افزار', 'SW', 140, '1234567', '1390/07/01', '', 'فعال', '1001', 'زهرا رضایی', '1403/02/15'],
      ['40114', 'مهندسی کامپیوتر', 'کارشناسی ارشد', 'گروه مهندسی کامپیوتر', 'دانشکده فنی و مهندسی', 'هوش مصنوعی', 'AI', 32, '', '1398/11/20', '', 'فعال', '', '', ''],
    ],
    help: [
      'یک رشته می‌تواند در چند مقطع تکرار شود؛ ستون «مقطع» تفکیک‌کننده است و اکیداً پر شود.',
  ...
  course: {
    title: 'دروس',
    headers: ['کد درس', 'نام درس', 'واحد', 'واحد نظری', 'واحد عملی', 'نوع', 'مقطع', 'گروه آموزشی'],
    example: [
      ['CE-101', 'مبانی برنامه‌نویسی', 3, 3, 0, 'نظری', 'کارشناسی', 'مهندسی کامپیوتر'],
      ['CE-102', 'آزمایشگاه مدار منطقی', 1, 0, 1, 'عملی', 'کارشناسی', 'مهندسی کامپیوتر'],
    ],
    help: [
      ...
      '«مقطع» با عنوان یا کد مقاطع تعریف‌شده تطبیق می‌خورد (کارشناسی، کارشناسی ارشد…) و «گروه آموزشی» با نام یا کد گروه؛ موارد تطبیق‌نخورده در میز «تطبیق کدها» قابل اصلاح‌اند.',
